...
**5년차 Unity 게임 클라이언트 프로그래머**입니다.
라이브 서비스 중인 모바일 캐주얼 퍼즐 게임(매치3)에서
**시스템 설계 · 신규 콘텐츠 개발 · 성능 최적화 · 내부 툴 개발**을 주도적으로 수행해왔습니다.
...
2025년 콘텐츠 고도화 기간 클라이언트 작업 대부분을 담당하였으며,
해당 기간 프로젝트 **ARPDAU 전년 대비 약 50% 성장, 매출 약 25% 성장**을 기록했습니다.
...
### [내부 툴 개발 및 팀 기여](./tools-development.md)
